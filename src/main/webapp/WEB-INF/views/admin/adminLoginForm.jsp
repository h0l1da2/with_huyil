		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<h3 class="mb-4 text-center">관리자</h3>
			  ...
			  <div class="social d-flex text-center">
				<a href="<c:url value='/admins/join'/>" class="px-2 py-2 mr-md-1 rounded join"><span class="ion-logo-facebook mr-2"></span> 관리자 가입</a>
			</div>
		      </div>
				</div>
			</div>
