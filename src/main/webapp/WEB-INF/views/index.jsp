<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <link rel="stylesheet" href="/static/user/css/profile-info.css">
            <script src="/static/user/js/user-profile-info.js" defer></script>
            <style>
                .title {
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li style=" margin: auto 0; cursor: pointer; position: relative;" class="user-profile">
                                <img src="/static/host/images/카리나.jpg" alt="카리나" style="width: 35px; height: 35px;">
                                <div class="user-profile-detail">
                                    <a href="/user-book-check">유저 예약내역</a> <br>
                                    <a href="/host-book-check">판매재 판매내역</a>
                                </div>
                            </li>
                            <li>
                            </li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                            <div class="room">
                                <a href="hotelList.jsp" class="img d-flex justify-content-center align-items-center"
                                    style="background-image: url(static/home/images/room-1.jpg);">
                                ...
                                <div class="text p-3 text-center">
                                    ...
                                    <hr>
                                    <p class="pt-1"><a href="room-single.html" class="btn-custom">지금 찾아보기 <span
                        ...
                        <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                            <div class="room">
                                <a href="hotelList.jsp" class="img d-flex justify-content-center align-items-center"
                                    style="background-image: url(static/home/images/room-2.jpg);">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <span class="icon-search2"></span>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                            <div class="room">
                                <a href="hotelList.jsp" class="img d-flex justify-content-center align-items-center"
                                    style="background-image: url(static/home/images/room-3.jpg);">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <span class="icon-search2"></span>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                            <div class="room">
                                <a href="hotelList.jsp" class="img d-flex justify-content-center align-items-center"
                                    style="background-image: url(static/home/images/room-4.jpg);">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <span class="icon-search2"></span>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                            <div class="room">
                                <a href="hotelList.jsp" class="img d-flex justify-content-center align-items-center"
                                    style="background-image: url(static/home/images/room-5.jpg);">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <span class="icon-search2"></span>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                            <div class="room">
                                <a href="hotelList.jsp" class="img d-flex justify-content-center align-items-center"
                                    style="background-image: url(static/home/images/room-6.jpg);">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <span class="icon-search2"></span>
                                    </div>
                                </a>
                    ...
                    <div class="row mb-5">
                        <div class="col-md">
                            <div class="ftco-footer-widget mb-4">
                                ...
                                <p>진짜 개쩌는 호텔진짜 개쩌는 호텔진짜 개쩌는 호텔진짜 개쩌는 호텔진짜 개쩌는 호텔진짜 개쩌는 호텔진짜 개쩌는 호텔진짜 개쩌는 호텔진짜 개쩌는 호텔ㅇㅇ
                                </p>
                            </div>
                        </div>
                        <div class="col-md">
                        ...
                        <div class="col-md">
                            <div class="ftco-footer-widget mb-4">
                                ...
                                <div class="block-23 mb-3">
                                    <ul>
                                        <li><span class="icon icon-map-marker"></span><span class="text">서울특별시
                                                금천구<br />가산디지털1로 70<br />호서대벤처타워 4층</span></li>
                                        <li><a href="#"><span class="icon icon-phone"></span><span class="text">010 8346
                                                    8610</span></a></li>
                                        <li><a href="#"><span class="icon icon-envelope"></span><span
                                                    class="text">whaleee@naver.com</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
