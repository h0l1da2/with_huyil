...
<html lang="ko">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/">위드휴일</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="/businessHome" class="nav-link">호스트등록</a></li>
	        ...
	        <div class="col-lg-9">
		    			...
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
		    				<div class="room">
		    					...
		    					<div class="text p-3 text-center">
		    						<h3 class="mb-3"><a href="rooms-single.html">휴일 호텔</a></h3>
		    						<p><span class="price mr-2">1000만</span> <span class="per">1박</span></p>
		    						<ul class="list">
		    							<li><p class="rate"><span><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i></span></p></li>
		    							<li><span>주소</span> 경기 부천시</li>
		    						</ul>
		    						<hr>
		    	...
		    	<div class="col-lg-3 sidebar">
	      		<div class="sidebar-wrap bg-light ftco-animate">
		              ...
		              <div class="form-group">
		                <input type="text" id="checkin_date" class="form-control checkout_date" placeholder="Check Out">
		              </div>
		              <div class="form-group">
		              ...
		              <div class="form-group">
		              	<div class="range-slider">
		              		<span>
										    <input type="number" value="2500" min="0" max="120000"/>	-
										    <input type="number" value="2500" min="0" max="120000"/>
										  </span>
	      		...
	      		<div class="sidebar-wrap bg-light ftco-animate">
	      			<h3 class="heading mb-4">Review</h3>
