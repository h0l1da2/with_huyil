  ...
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col text-center">
        <div class="block-27">
          <ul>
              <c:if test="${ph.showPrev}"><li><a href="<c:url value="/user/info/book/complete${ph.getPageInfo(ph.beginPage-1)}"/>">&lt;</a></li></c:if>
            <c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
            <li<c:if test="${ph.viewPage eq i}"> class="active"</c:if>>
                <a href="<c:url value="/user/info/book/complete${ph.getPageInfo(i)}"/>">${i}</a></li>
            </c:forEach>
            <c:if test="${ph.showNext}"><li><a href="<c:url value="/user/info/book/complete${ph.getPageInfo(ph.endPage+1)}"/>">&gt;</a></li></c:if>
          </ul>
        </div>
      </div>
    </div>
