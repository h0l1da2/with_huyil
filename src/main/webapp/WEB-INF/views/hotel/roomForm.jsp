...
<section id="hotelForm">
    <form name="roomForm" action="/hosts/roomForm" method="post" enctype="multipart/form-data" onsubmit="return checkForm();">
        <div style="margin:0 0 30px 100px;" class="form-group">
            ...
            <input type="text" id="name" name="name" style="width:300px; height:50px;" placeholder="예)디럭스 더블 트윈">
            <br> <br>
            ...
            <textArea style=resize:none; id="content" name="content" rows="7" cols="100"></textArea> <br> <br>
            ...
            <input type="text" id="price" name="normalPrice" style="width:200px; height:50px; padding-right: 10px; text-align: right" placeholder="예)50000">원
            <br> <br> <br>
