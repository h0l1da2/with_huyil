            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <c:if test="${ph.showPrev}"><a href="<c:url value="/admin/userList${ph.getPageInfo(ph.beginPage-1)}"/>">&lt;</a></c:if>
                        <c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
                            <a href="<c:url value="/admin/userList${ph.getPageInfo(i)}"/>" <c:if test="${ph.viewPage eq i}"> class="active"</c:if>>${i}</a>
                        </c:forEach>
                        <c:if test="${ph.showNext}"><a href="<c:url value="/admin/userList${ph.getPageInfo(ph.endPage+1)}"/>">&gt;</a></c:if>
                    </div>
                </div>
